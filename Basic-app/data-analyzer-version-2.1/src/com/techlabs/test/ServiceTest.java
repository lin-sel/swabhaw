...
public class ServiceTest {
	...
	public static void main(String[] args) {
		...
		System.out.println(totalEmployeeInDesignation(DDesignation.PRESIDENT, service));
	}

	private static String totalEmployeeInDesignation(DDesignation president, DataAnalyzer service) {
